...
ResumeMake 문서는 `설치/실행 -> 구조 이해 -> 제품 기준 -> 운영/품질 -> 변경 이력` 순서로 읽는 것이 가장 빠릅니다.
...
- [루트 README](../README.md)
  - 저장소를 처음 받은 사람이 가장 먼저 읽는 문서
- [프로젝트 구조](./PROJECT_STRUCTURE.md)
  - 현재 코드베이스가 어떤 기준으로 나뉘어 있는지 설명하는 구현 지도
- [서비스 기획서](./SERVICE_PLAN.md)
  - MVP 범위, 요구사항, 아키텍처, 상태 전이 규칙의 기준 문서
- [다음 작업 로드맵](./NEXT_STEPS.md)
  - 앞으로의 개선 우선순위를 정리한 실행 계획
- [운영 런북](./OPS_RUNBOOK.md)
  - 로컬 실행 절차, 점검 항목, 장애 대응

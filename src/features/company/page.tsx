...
import { AppFrame } from "@/shared/ui/frame/app-frame";
import { CompanyDetailsSection } from "@/features/company/ui/details-section";
import { ReasoningInline } from "@/shared/ui/reasoning-inline";
import { SaveActionCard } from "@/shared/ui/workflow/save-action-card";
import { SourceInputCard } from "@/shared/ui/workflow/source-input-card";
import { UrlFetchPanel, type UrlFetchPreview } from "@/shared/ui/workflow/url-fetch-panel";
import { useRequiredFieldFocus } from "@/shared/hooks/use-required-field-focus";
import { usePipelineStreamTask } from "@/shared/hooks/use-pipeline-stream-task";
import { toAgentRunOptions } from "@/shared/lib/agent-settings";
import { formatSavedAt } from "@/shared/lib/date-format";
import { stringifyInlineList, stringifyLineList } from "@/shared/lib/list-input";
import type { ApiFailure, ApiSuccess, Company } from "@/shared/lib/types";
import { hasResumeConfirmed, usePipeline } from "@/entities/pipeline/model/pipeline-context";
